...
function spawnEnemies() {
    ...
    if (rand < 0.333) { 
        radius = 30; color = 'hsl(240, 50%, 60%)'; speed = 1.5; scoreValue = 10;
    } else if (rand < 0.666) { 
        radius = 20; color = 'hsl(60, 50%, 60%)'; speed = 2; scoreValue = 25;
    } else { 
        radius = 10; color = 'hsl(0, 80%, 60%)'; speed = 2.8; scoreValue = 50;
    }
    let x, y;
    if (Math.random() < 0.5) {
